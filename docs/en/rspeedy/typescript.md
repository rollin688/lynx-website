...
Rspeedy by default reads the `tsconfig.json` file from the root directory. You can use the [source.tsconfigPath](/api/config/#source-tsconfigpath) to configure a custom tsconfig.json file path.
