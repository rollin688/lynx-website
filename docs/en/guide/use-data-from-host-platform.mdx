...
:::note Prerequisites
You need to complete the instructions in [Integrate with existing applications](/guide/start/integrate-with-existing-apps.html) to ensure that your application has integrated Lynx and have a basic understanding of Lynx's Native API.
:::
...
[`LynxView.updateData()`]: /api/lynx-native-api/lynx-view/update-meta-data
[`useInitData()`]: /api/react/hooks/useInitData
[`InitDataConsumer`]: /api/react/components/InitDataConsumer
[`InitDataProvider`]: /api/react/components/InitDataProvider
[`lynx.registerdataprocessors`]: /api/react/types/Lynx
[`LynxContext.updateData()`]: /api/lynx-native-api/lynx-context/update-meta-data
